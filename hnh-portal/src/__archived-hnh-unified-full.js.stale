--aa678eaa0d521d30313112a7e2b0cf5914b25e77d977b799cd7056b59838
...
// worker.js
var VERSION = "4.0.0";
var HOSPITAL_NAME = "Hayat National Hospital - Gharnata";
var FACILITY_LICENSE = "10000000000988";
var CORS = {
...
var JSON_HEADERS = { ...CORS, ...SECURITY_HEADERS, "Content-Type": "application/json; charset=utf-8" };
var HTML_HEADERS = { ...SECURITY_HEADERS, "Content-Type": "text/html; charset=utf-8", "Cache-Control": "public, max-age=300" };
...
var _rateCounts = /* @__PURE__ */ new Map();
function rateLimit(ip, maxReq = 120, windowMs = 6e4) {
  const now = Date.now();
...
__name(nphiesMirror, "nphiesMirror");
...
__name(handlePatients, "handlePatients");
...
__name(handleClaims, "handleClaims");
...
__name(handleVisits, "handleVisits");
...
__name(handleLabResults, "handleLabResults");
...
__name(handlePriorAuth, "handlePriorAuth");
async function handleRCM(env) {
  ...
  (byStatus.results || []).forEach((r) => {
    statusMap[r.status] = { count: r.count, total: r.total };
  });
...
__name(handleEligibility, "handleEligibility");
...
__name(handleNphies, "handleNphies");
...
function serveHTML(lang = "ar") {
  ...
  const t = /* @__PURE__ */ __name((ar, en) => isAr ? ar : en, "t");
...
<header class="header">
  <div class="header-inner">
    <a href="/" class="logo">
      <div class="logo-icon">\u{1F3E5}</div>
...
<section class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-btns">
      <a href="tel:966920000094" class="btn btn-accent">${t("\u{1F4C5} \u0627\u062D\u062C\u0632 \u0645\u0648\u0639\u062F", "\u{1F4C5} Book Appointment")}</a>
...
<footer class="footer">
  <div class="container">
    ...
    <div class="footer-bottom">\xA9 2026 ${t("\u0645\u0633\u062A\u0634\u0641\u0649 \u0627\u0644\u062D\u064A\u0627\u0629 \u0627\u0644\u0648\u0637\u0646\u064A", "Hayat National Hospital")} \u2014 BrainSAIT Healthcare OS ${VERSION}</div>
  </div>
</footer>

<a href="https://wa.me/966920000094" class="wa" target="_blank" rel="noopener">\u{1F4AC}</a>
...
async function loadDepartments() {
  try {
    ...
    grid.innerHTML = depts.map(dep => {
      const icons = {Surgery:'\u{1F52A}',Cardiology:'\u2764\uFE0F',Pediatrics:'\u{1F476}',Orthopedics:'\u{1F9B4}',Dermatology:'\u{1F486}','Internal':'\u{1FA7A}','OB/GYN':'\u{1F469}',Ophthalmology:'\u{1F441}\uFE0F',Neurology:'\u{1F9E0}',Dentistry:'\u{1F9B7}',Urology:'\u{1FAC1}',Psychiatry:'\u{1F9D8}'};
      const icon = Object.entries(icons).find(([k]) => dep.includes(k))?.[1] || '\u{1F3E5}';
    ...
    grid.innerHTML = (d.branches || []).map(b => \`
      <div class="card branch-card">
        <div class="branch-header">
          <div style="font-size:1.5rem;margin-bottom:8px;">\u{1F3E5}</div>
        ...
        <div class="branch-body">
          ...
          <a href="tel:\${b.phone.replace('+','')}" class="btn btn-primary btn-sm">\${IS_AR ? '\u{1F4DE} \u0627\u062A\u0635\u0644' : '\u{1F4DE} Call'}</a>
        </div>
      </div>
    \`).join('');
  } catch {}
...
var worker_default = {
  async fetch(request, env, ctx) {
    ...
    if (path === "/" || path === "/index.html") {
      const lang2 = url.searchParams.get("lang") || "ar";
      return serveHTML(lang2);
    }
