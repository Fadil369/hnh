...
const DE = [
  { i: '🚑', nA: 'الطوارئ', nE: 'Emergency', dA: 'خدمة 24 ساعة للحالات الحرجة والمستعجلة.', dE: '24/7 Critical and urgent care services.' },
  { i: '🫀', nA: 'القلب', nE: 'Cardiology', dA: 'قسطرة قلبية وجراحة قلب متطورة بأيدي استشاريين.', dE: 'Advanced cardiac care and surgery by consultants.' },
  { i: '🦴', nA: 'العظام', nE: 'Orthopedics', dA: 'علاج المفاصل والكسور والعمود الفقري والطب الرياضي.', dE: 'Treatment for joints, fractures, spine, and sports medicine.' },
  { i: '👶', nA: 'الأطفال', nE: 'Pediatrics', dA: 'رعاية متخصصة للأطفال وحديثي الولادة بأعلى المعايير.', dE: 'Expert care for children and neonates at highest standards.' },
  { i: '🤰', nA: 'النساء والولادة', nE: 'OB/GYN', dA: 'متابعة الحمل والولادة الطبيعية والقيصرية بأمان.', dE: 'Safe pregnancy follow-up and delivery services.' },
  { i: '🦷', nA: 'الأسنان', nE: 'Dentistry', dA: 'تجميل وزراعة وعلاج الأسنان بأحدث التقنيات.', dE: 'Cosmetic, implant, and dental care with latest tech.' },
  { i: '👁️', nA: 'العيون', nE: 'Ophthalmology', dA: 'جراحة العيون والليزك وتصحيح النظر.', dE: 'Eye surgery, LASIK, and vision correction.' },
  { i: '🧠', nA: 'المخ والأعصاب', nE: 'Neurology', dA: 'تشخيص وعلاج اضطرابات الجهاز العصبي والسكتات.', dE: 'Diagnosis and treatment of nervous system disorders.' }
];
const BR = [
...
function ecoSys(t) {
  return '<section class="se sea" id="ecosystem"><div class="co"><div class="sh an"><h2>'+t.ecosystemTitle+'</h2><div class="gl"></div><p>'+t.ecosystemSub+'</p></div><div class="ec"><h3 style="font-size:1.1rem;font-weight:700;color:var(--p);margin-bottom:24px;">\u{1F465} '+t.navPortal+'</h3><div class="ec-g">'+
    '  <button class="ec-c an d1" data-open="patient"><div class="ec-badge ok">Live</div><div class="ec-ic" style="background:rgba(0,95,184,0.1);color:var(--s)">\u{1F9D1}\u200D\u{1F3EB}</div><div class="ec-n">'+t.patientTitle+'</div><div class="ec-d">'+t.patientDesc+'</div></button>'+
    '  <a href="/provider-dashboard" class="ec-c an d2" style="display:block;text-decoration:none;color:inherit"><div class="ec-badge ok">Live</div><div class="ec-ic" style="background:rgba(16,185,129,0.1);color:var(--success)">\u{2B50}</div><div class="ec-n">'+t.providerTitle+'</div><div class="ec-d">'+t.providerDesc+'</div></a>'+
    '  <button class="ec-c an d3" data-open="eligibility"><div class="ec-badge ok">Live</div><div class="ec-ic" style="background:rgba(212,175,55,0.1);color:var(--a)">\u{1F3E6}</div><div class="ec-n">'+t.payerTitle+'</div><div class="ec-d">'+t.payerDesc+'</div></button>'+
    '  <a href="/academy" class="ec-c an d4" style="display:block;text-decoration:none;color:inherit"><div class="ec-badge ok">Live</div><div class="ec-ic" style="background:rgba(124,58,237,0.1);color:#7C3AED">\u{1F393}</div><div class="ec-n">'+t.studentTitle+'</div><div class="ec-d">'+t.studentDesc+'</div></a>'+
    '  <button class="ec-c an d5" data-open="appointment"><div class="ec-badge ok">Live</div><div class="ec-ic" style="background:rgba(236,72,153,0.1);color:#EC4899">\u{1F481}</div><div class="ec-n">'+t.receptionTitle+'</div><div class="ec-d">'+t.receptionDesc+'</div></button>'+
    '  <button class="ec-c an d6" data-open="status"><div class="ec-badge warn">Secure</div><div class="ec-ic" style="background:rgba(100,116,139,0.1);color:var(--tl)">\u{1F512}</div><div class="ec-n">'+t.adminTitle+'</div><div class="ec-d">'+t.adminDesc+'</div></button>'+
    '  <button class="ec-c an d5" data-open="rcm"><div class="ec-badge warn">Secure</div><div class="ec-ic" style="background:rgba(239,68,68,0.1);color:var(--danger)">\u{1F4B0}</div><div class="ec-n">'+t.rcmTitle+'</div><div class="ec-d">'+t.rcmDesc+'</div></button>'+
    '  <button class="ec-c an d6" data-open="basma"><div class="ec-badge ok">Basma</div><div class="ec-ic" style="background:rgba(16,185,129,0.1);color:var(--success)">\u{1F399}\uFE0F</div><div class="ec-n">'+t.basmaPortal+'</div><div class="ec-d">'+t.aiDesc+'</div></button>'+
    '  <button class="ec-c an d1" data-open="homecare"><div class="ec-badge ok">New</div><div class="ec-ic" style="background:rgba(16,185,129,0.1);color:var(--success)">\u{1F3E0}</div><div class="ec-n">'+t.hcTitle+'</div><div class="ec-d">'+t.hcSub+'</div></button>'+
    '  <button class="ec-c an d2" data-open="telehealth"><div class="ec-badge ok">New</div><div class="ec-ic" style="background:rgba(14,165,233,0.1);color:var(--s)">\u{1F3A5}</div><div class="ec-n">'+t.thTitle+'</div><div class="ec-d">'+t.thSub+'</div></button>'+
    '  <button class="ec-c an d1" data-open="givc"><div class="ec-badge ok">GIVC</div><div class="ec-ic" style="background:rgba(124,58,237,0.1);color:#7C3AED">\u{1F310}</div><div class="ec-n">'+t.givcPortal+'</div><div class="ec-d">'+t.givcDesc+'</div></button>'+
  '</div></div><div class="ec"><h3 style="font-size:1.1rem;font-weight:700;color:var(--p);margin-bottom:24px;">\u{1F517} '+t.integrationsTitle+'</h3><div class="ig" id="liveStatus" style="display:grid;grid-template-columns:repeat(auto-fill, minmax(200px,1fr));gap:16px"><div class="ld"><div class="spn"></div></div></div></div><div class="ec"><h3 style="font-size:1.1rem;font-weight:700;color:var(--p);margin-bottom:24px;">\u{1F916} '+t.aiTitle+'</h3><div class="ai-s"><div class="ai-v"><div class="ai-orb">\u{1F399}\uFE0F</div><p>'+t.aiDesc+'</p></div><div class="ai-c"><h3>'+t.aiTitle+'</h3><p>'+t.aiDesc+'</p><div class="ai-btns"><button data-open="basma" class="btn ba bs">'+t.aiTalkBtn+'</button><button data-open="basma" class="btn bp bs">'+t.aiChatBtn+'</button></div><div class="eh" style="display:flex;gap:12px;margin-top:20px;flex-wrap:wrap"><span class="lb bs">DeepSeek AI</span><span class="lb bs">Oracle Health</span><span class="lb bs">NPHIES</span><span class="lb bs">Multi-language</span></div></div></div></div></div></section>';
}
...
function featureSec(t) {
  return '<section class="se sea" id="features"><div class="co"><div class="sh an"><h2>'+t.featureTitle+'</h2><div class="gl"></div><p>'+t.featureSub+'</p></div><div class="g3">'+
    '<a class="cd an d1" href="/provider-dashboard" style="text-decoration:none;color:inherit"><div class="ci">\u{1F468}\u200D\u{2695}\uFE0F</div><h3>'+t.featureProvider+'</h3><p>'+t.featureProviderDesc+'</p><b style="margin-top:auto;color:var(--p)">'+t.launch+' →</b></a>'+
    '<button class="cd an d2" data-open="eligibility"><div class="ci">\u{2705}</div><h3>'+t.featureEligibility+'</h3><p>'+t.featureEligibilityDesc+'</p><b style="margin-top:auto;color:var(--p)">'+t.launch+' →</b></button>'+
    '<button class="cd an d3" data-open="homecare"><div class="ci">\u{1F3E0}</div><h3>'+t.featureHomecare+'</h3><p>'+t.featureHomecareDesc+'</p><b style="margin-top:auto;color:var(--p)">'+t.launch+' →</b></button>'+
    '<button class="cd an d4" data-open="telehealth"><div class="ci">\u{1F3A5}</div><h3>'+t.featureTelehealth+'</h3><p>'+t.featureTelehealthDesc+'</p><b style="margin-top:auto;color:var(--p)">'+t.launch+' →</b></button>'+
    '<a class="cd an d5" href="#search" style="text-decoration:none;color:inherit"><div class="ci">\u{1F50D}</div><h3>'+t.featureSearch+'</h3><p>'+t.featureSearchDesc+'</p><b style="margin-top:auto;color:var(--p)">'+t.launch+' →</b></a>'+
    '<button class="cd an d6" data-open="rcm"><div class="ci">\u{1F4B0}</div><h3>'+t.featureRcm+'</h3><p>'+t.featureRcmDesc+'</p><b style="margin-top:auto;color:var(--p)">'+t.launch+' →</b></button>'+
  '</div></div></section>';
}

function dhsSec(t) {
  return '<section class="se sel" id="digitalHealth"><div class="co"><div class="sh an"><h2>'+t.digitalTitle+'</h2><div class="gl"></div><p>'+t.digitalSub+'</p></div><div class="g3">'+
    '<div class="cd an d1"><div class="ci">\u{1F3E0}</div><h3 style="color:var(--p)">'+t.hcTitle+'</h3><p>'+t.hcDesc+'</p><button data-open="homecare" class="btn bp bs" style="margin-top:16px;">'+t.hcTitle+' \u2192</button></div>'+
    '<div class="cd an d2"><div class="ci">\u{1F3A5}</div><h3 style="color:var(--p)">'+t.thTitle+'</h3><p>'+t.thDesc+'</p><button data-open="telehealth" class="btn bp bs" style="margin-top:16px;">'+t.thTitle+' \u2192</button></div>'+
    '<div class="cd an d3"><div class="ci">\u{1F4E7}</div><h3 style="color:var(--p)">'+t.emailTitle+'</h3><p>'+t.emailDesc+'</p></div>'+
  '</div></div></section>';
}
...
function hub(t) {
  return '<div class="mx" id="mx"><div class="mx-b" data-close="1"></div><div class="mx-p"><button class="mx-x" data-close="1">×</button><div class="mx-h"><h3 id="mxTitle" style="color:var(--p)"></h3><p id="mxSub"></p></div><div id="mxBody"></div><div class="mx-r" id="mxRes" style="display:none"></div></div></div>' +
    '<template id="tpl-appointment"><div class="fx"><div class="fi"><label>'+t.quickName+'</label><input id="apName" placeholder="Name"></div><div class="fi"><label>'+t.quickPhone+'</label><input id="apPhone" inputmode="tel" placeholder="+966"></div><div class="fi"><label>'+t.quickNational+'</label><input id="apNational" placeholder="ID #"></div><div class="fi"><label>'+t.quickDept+'</label><select id="apDept"><option>Cardiology</option><option>OB/GYN</option><option>Pediatrics</option><option>Dermatology</option><option>Orthopedics</option></select></div><div class="fi"><label>'+t.quickDate+'</label><input id="apDate" type="date"></div><div class="fi"><label>'+t.quickTime+'</label><input id="apTime" type="time"></div><div class="fi full"><label>'+t.quickComplaint+'</label><textarea id="apReason" placeholder="Reason..."></textarea></div></div><div class="mx-a"><button class="btn bp bl" data-act="appointment">'+t.sendRequest+'</button><button class="btn bw bl" data-open="eligibility">'+t.eligModalTitle+'</button></div></template>' +
    '<template id="tpl-basma"><div class="fx"><div class="fi full"><label>'+t.askBasma+'</label><textarea id="baMsg" placeholder="'+t.searchPlaceholder+'" style="min-height:160px;font-size:1.2rem"></textarea></div></div><div class="mx-a"><button class="btn ba bl" data-act="basma" style="flex:1">'+t.askBasma+'</button><button class="btn bp bl" data-act="voice" style="width:60px;padding:0">\u{1F399}\uFE0F</button></div></template>' +
    '<template id="tpl-homecare"><div class="fx"><div class="fi"><label>'+t.quickName+'</label><input id="hcName"></div><div class="fi"><label>'+t.quickPhone+'</label><input id="hcPhone" inputmode="tel"></div><div class="fi"><label>'+t.quickNational+'</label><input id="hcNational"></div><div class="fi"><label>'+t.quickDate+'</label><input id="hcDate" type="date"></div><div class="fi"><label>'+t.quickTime+'</label><input id="hcTime" type="time"></div><div class="fi"><label>'+t.quickDept+'</label><select id="hcType"><option value="routine">Routine</option><option value="iv-therapy">IV Therapy</option><option value="wound-care">Wound Care</option><option value="physiotherapy">Physiotherapy</option></select></div><div class="fi full"><label>'+t.quickAddress+'</label><textarea id="hcAddress" placeholder="Full address..."></textarea></div><div class="fi full"><label>'+t.quickComplaint+'</label><textarea id="hcReason"></textarea></div></div><div class="mx-a"><button class="btn ba bl" data-act="homecare" style="width:100%">'+t.sendRequest+'</button></div></template>' +
    '<template id="tpl-telehealth"><div class="fx"><div class="fi"><label>'+t.quickName+'</label><input id="thName"></div><div class="fi"><label>'+t.quickPhone+'</label><input id="thPhone" inputmode="tel"></div><div class="fi"><label>'+t.quickNational+'</label><input id="thNational"></div><div class="fi"><label>'+t.quickDate+'</label><input id="thDate" type="date"></div><div class="fi"><label>'+t.quickTime+'</label><input id="thTime" type="time"></div><div class="fi"><label>'+t.quickDept+'</label><select id="thType"><option value="consultation">Consultation</option><option value="follow-up">Follow-up</option><option value="second-opinion">Second opinion</option><option value="pharmacy">Pharmacy</option></select></div><div class="fi full"><label>'+t.quickComplaint+'</label><textarea id="thReason"></textarea></div></div><div class="mx-a"><button class="btn ba bl" data-act="telehealth" style="width:100%">'+t.sendRequest+'</button></div></template>' +
    '<template id="tpl-eligibility"><div class="fx"><div class="fi"><label>'+t.quickInsurance+'</label><input id="elIns"></div><div class="fi"><label>'+t.quickNational+'</label><input id="elNat"></div><div class="fi full"><label>'+t.quickDept+'</label><select id="elType"><option value="medical">Medical</option><option value="hospital">Hospital</option><option value="pharmacy">Pharmacy</option><option value="dental">Dental</option></select></div></div><div class="mx-a"><button class="btn ba bl" data-act="eligibility" style="width:100%">'+t.sendRequest+'</button></div></template>' +
    '<template id="tpl-givc"><div class="fx"><div class="fi"><label>Name (AR)</label><input id="givcNameAr"></div><div class="fi"><label>Name (EN)</label><input id="givcNameEn"></div><div class="fi"><label>National ID</label><input id="givcNat"></div><div class="fi"><label>Specialty</label><input id="givcSpec"></div><div class="fi"><label>License #</label><input id="givcLic"></div><div class="fi"><label>Branch</label><select id="givcBranch"><option value="R001">Riyadh</option><option value="M001">Madinah</option><option value="K001">Khamis</option><option value="J001">Jizan</option><option value="U001">Unaizah</option></select></div></div><div class="mx-a"><button class="btn ba bl" data-act="givc-register">'+t.givcRegister+'</button><button class="btn bw bl" data-act="givc-network">'+t.givcNetwork+'</button></div></template>' +
    '<template id="tpl-list"><div id="miniList" style="display:grid;grid-template-columns:repeat(auto-fit, minmax(240px, 1fr));gap:12px"><div class="ld"><div class="spn"></div></div></div></template>';
}
